...
本ソフトウェアは**教育および技術研究を目的**として公開されています。利用にあたっては次の点に留意してください。

- 日本国内において、電波の受信内容を**傍受して窃用したり、その存在・内容を他人に漏らすことは電波法により禁止**されています。
- 秘話（音声スクランブル）の解読機能を含みます。**第三者の通信の秘密を侵す用途に使用しないでください。**
- 本ソフトウェアの利用によって生じたいかなる結果についても、作者は一切の責任を負いません。

適用される法令を理解し、自己の責任の範囲内で使用してください。
